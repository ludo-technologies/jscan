...
func (a *ASTFeatureExtractor) ExtractFeatures(ast *TreeNode) ([]string, error) {
	...
	// Structural patterns (JavaScript/TypeScript specific)
...
// extractPatterns extracts structural pattern tokens based on JavaScript/TypeScript constructs
func (a *ASTFeatureExtractor) extractPatterns(ast *TreeNode) []string {
	...
	// JavaScript/TypeScript control flow patterns
	addIf("IfStatement")
	addIf("SwitchStatement")
	addIf("ForStatement")
	addIf("ForInStatement")
	addIf("ForOfStatement")
	addIf("WhileStatement")
	addIf("DoWhileStatement")
	addIf("TryStatement")
	addIf("WithStatement")

	// Function patterns
	addIf("FunctionDeclaration")
	addIf("FunctionExpression")
	addIf("ArrowFunctionExpression")
	addIf("MethodDefinition")
	addIf("AsyncFunctionDeclaration")
	addIf("GeneratorFunctionDeclaration")

	// Class patterns
	addIf("ClassDeclaration")
	addIf("ClassExpression")

	// Common statement patterns
	addIf("ReturnStatement")
	addIf("ThrowStatement")
	addIf("BreakStatement")
	addIf("ContinueStatement")

	// Variable patterns
	addIf("VariableDeclaration")
	addIf("AssignmentExpression")

	// Expression patterns
	addIf("CallExpression")
	addIf("MemberExpression")
	addIf("BinaryExpression")
	addIf("LogicalExpression")
	addIf("ConditionalExpression")
	addIf("NewExpression")
	addIf("AwaitExpression")
	addIf("YieldExpression")

	// Module patterns
	addIf("ImportDeclaration")
	addIf("ExportNamedDeclaration")
	addIf("ExportDefaultDeclaration")

	// TypeScript specific
	addIf("InterfaceDeclaration")
	addIf("TypeAliasDeclaration")
	addIf("EnumDeclaration")
